...
/**
 * Java Configuration : Servlet App
 * Java Configuration and Form Login
 * 
 * Now we will configure the security to secure our application. For now, we will allow 
 * /users endpoint for public access so that we can validate our jwt authentication later 
 * @author ogounaya
 *
 */
